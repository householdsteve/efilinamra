...
$search = isset($_REQUEST['city']) && isset($_REQUEST['city']) != '' ? trim($_REQUEST['city']) : '-1';

$searchData = $cafeObject->getBySearch($search);
...
$cafeData = $cafeObject->getAllSearch($search);
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
		...
		<title>Armani/Ristorante | Locations Search | <?php echo $searchData['name']; ?></title>
...
<div id="search-box"><input id="search" /> <!-- a id="my-location" href="/#">Find my location</a--> </div>
          ...
          <div class="row-fluid">
			...
			<h4><?php echo $searchData['name']; ?></h4>
			...
			?>
			  <li>
			  	...
			  	<div class="overlay-content">
			  		 	...
			  		 	<a  class= 'hidden-read-more' style="display: none;" href="/locations/<?php echo $cafe['city_link'].'/'.$cafe['cafe_link']; ?>">Discover</a>
			  		...
			  		<span class="city"><?php echo strtoupper($cafe['city_link']); ?></span>
			  	</div>
			  ...
			  <span class="cafe-address" >
			  	    <?php echo strtoupper($cafe['cafe_name']); ?>	<br/>
					<?php echo strtoupper($cafe['cafe_address']); ?><br/>
