...
$device = ($detect->isMobile() or $detect->isTablet()) ? 'mobile_' : '';
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Armani/Ristorante | Locations | <?php echo $cafeData['city_name']; ?> | <?php echo $cafeData['cafe_name']; ?></title>
   ...
   <?php require_once 'includes/header_html.php'; ?>
						...
						<div class="cafe-content-wrap">
							<div class="content">
								...
								<div style="clear:left"></div>
														<?php if( $cafeData['cafe_bookinglink']!='') { ?>
			
			<a class='bookingbut' target='_blank' href="<?php echo $cafeData['cafe_bookinglink']; ?>"> Reserve a Table </a>
			<?php } ?>
        ...
        <div class="span9 web-copy">
          <div class="row-fluid">
			...
			<ul class="cafe-slider">
				...
				<!--	<div class='gal_loader'></div>	-->
					
				<?php	}  ?>		
					
					    
					   <img src="<?php    echo $image['cafeimage_path'].'/'.$device.$image['cafeimage_code'].$image['cafeimage_extension']; ?>" />
				</li>
				<?php 
			        	$c_++;
						}
	...
	<?php require_once 'includes/footer-menu.php'; ?>
			...
			// $('#leftMenu .accordion-group .accordion-group').click(function(){
			 ...
			 //})
				...
				function toggleMap(e) {
					...
					/*
					var origHeight = 250//$('#map-canvas').data('origHeight');
               ...
               $("#expand-map").attr('href' , "http://maps.google.com/maps?t=h&q=loc:"+document.getElementById('latitude').value +"," +document.getElementById('longitude').value+"&z=18 ").css({'height': '12px','padding':'5px','width':'auto','background':'black','color':'#ffffff!important', 'font-size':'10px' });
            
               $("#expand-map").text('view in Map').attr('target','_blank');
                }else{
			   ...
			   sel_current.addClass('active');
			   var rel=sel_current.attr('rel').split('-');
			   
			    $('a[href="#collapse'+ rel[1]+'"]').addClass('active');
        ...
        @media (min-width: 768px) and (max-width: 820px) {
         ...
         a.bookingbut{
            ...
            .gal_loader{
            	...
            	right:0;
            	bottom:0;
            	background:url('/img/ld.gif') no-repeat center center;
        ...
        @media (min-width: 980px) and (max-width: 1120px) {
         ...
         .verticaltabs-container > .tab-content {min-height:500px;}
         ...
         @media (max-width: 480px) {
        	 ...
        	 #menu-content   .tab-content ul{width:100%; margin:0 5% 0 0 ;float :none ; }
        		...
        		.verticaltabs-container .nav-tabs > li > a {
