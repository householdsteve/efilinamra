<?php /* Smarty version 2.6.20, created on 2014-01-27 15:46:39
         compiled from admin/categories/default.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'admin/categories/default.tpl', 38, false),)), $this); ?>
...
?>
							  <tr>
								<td><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['category_added'])) ? $this->_run_mod_handler('date_format', true, $_tmp) : smarty_modifier_date_format($_tmp)); ?>
</td>
								<td align="left"><a href="/admin/categories/details.php?code=<?php echo $this->_tpl_vars['item']['category_code']; ?>
"><?php echo $this->_tpl_vars['item']['category_code']; ?>
</a></td>	
								<td align="left"><?php echo $this->_tpl_vars['item']['category_name']; ?>
</td>	
								<td align="left"><?php if ($this->_tpl_vars['item']['category_active'] == '1'): ?><span class="success">Active</span><?php else: ?><span class="error">Not Active</span><?php endif; ?></td>
								<td align="left"><a class="link" href="javascript:deleteItem('<?php echo $this->_tpl_vars['item']['category_code']; ?>
