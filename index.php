...
<html class="no-js">
	...
	<head>
		...
		<title>Armani/Ristorante | Home</title>
				...
				<div class="span9 web-copy">
					<div class="hero-unit">
						...
						<div id="homeSlider">
							...
							<span class="message"><img src="img/welcome-logo.png" /> <a id='res_now' class='blk'  style='display: none'  href="/locations/reservation">RESERVE NOW</a></span>
...
<span class="city"><?php echo $featured["city_name"] ?></span>
									...
									<span class="address">
										<?php echo strip_tags( $featured["cafe_address"],'<div> <br>') ?>
									<br />
									<br />
							...
							<img class='clearfix imgmobile' style='clear:both' src="<?  echo $featured["cafeimage_path"]."/".$device.$featured["cafeimage_code"].$featured['cafeimage_extension']?>">
						</div><!--/span-->
					...
					<div class="row-fluid   hidden-phone">
						<div id="near-by" class="span12">
							...
							<img   src="<?  echo $featured["cafeimage_path"]."/".$device.$featured["cafeimage_code"].$featured['cafeimage_extension']?>">
						</div><!--/span-->
		...
		<script>
			$(document).ready(function() {
               ...
               if(!$('html').hasClass('touch')){
				...
				$("#the-story .overlay-area,#the-story span.cnt_st").click(function(e) {
					
					window.location=$('#the-story').find("a").attr('href');
