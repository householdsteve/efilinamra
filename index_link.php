				...
				<div class="span9 web-copy">
					<div class="hero-unit">
						...
						<div id="homeSlider">
							...
							<span class="message"><img src="img/welcome-logo.png" /></span>

							<ul class="slider">
								<li><img src="img/<?php echo($device) ?>home-1.jpg" />

									<a style="display: none;" href="cafe-tpl.html">RESERVE NOW</a>
						...
						<div id="near-by-phone" class="span12">
							<div class="content">
								...
								<div class='lf'>
									...
									<img src="img/armani-overlay-logo.png" alt="Emporio Armani - Cafe" />
									
								<!--	<a href="cafe-tpl.html">Read More</a>-->
								</div>

								<div  class='rg'>
<span class="city">Ayoama</span>

									<span class="address">Tokio
										<!--<br />
										utca 21,
										<br />
										Japan
			...
			$(document).ready(function() {
				...
				var slider = $('.slider').bxSlider({
					...
					onSlideAfter : function($slideElement, oldIndex, newIndex) {
                               	...
                               	mouseState?$('.active-caption').find('a,.img-overlay').fadeIn('fast'):''
					},
					onSlideBefore : function($slideElement, oldIndex, newIndex) {
						
						mouseState?$('.active-caption').find('a,.img-overlay').hide():'';
						$('.active-caption').removeClass('active-caption');
			          
			            $slideElement.addClass('active-caption');
					},

					onSliderLoad : function() {
						  pusher.find('li').not('li.bx-clone').eq(0).addClass('active-caption')
					}
               ...
               if(!$('html').hasClass('touch')){
				...
				pusher.on({
					...
					mouseenter : function(e) {
						...
						mouseState = true;
						 $('.active-caption').find('a,.img-overlay').fadeIn('fast');
						
					},
					mouseleave : function(e) {
						
						mouseState = false;
						$('.active-caption').find('a,.img-overlay').fadeOut('fast');
					}
				});
