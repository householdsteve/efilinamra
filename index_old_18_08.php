						...
						<div id="homeSlider">
							...
							<ul class="slider">
								<li><img src="img/<?php echo($device) ?>home-1.jpg" />
									...
									<!-- <a style="display: none;" href="cafe-tpl.html">Read More1</a>
									<span class="img-overlay"></span>-->
								</li>
								<li><img src="img/<?php echo($device) ?>home-2.jpg" />

									<!--<a style="display: none;" href="cafe-tpl.html">Read More2</a>
									<span class="img-overlay"></span>-->
								</li>
								<li><img src="img/<?php echo($device) ?>home-3.jpg" />

									<!--<a style="display: none;" href="cafe-tpl.html">Read More3</a>
									<span class="img-overlay"></span>-->
								</li>
							</ul>
						</div>
