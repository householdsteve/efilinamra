	...
	<input type="hidden" id="searchcity" name="searchcity" value="" />
          ...
          <div class="row-fluid">
			...
			<?php 
				...
				<div class="slider hidden-phone" ><pre>
				<?php 
				...
				?>
				   ...
				   <?php  
				     ...
				     if ($odd =='odd'){
				     	 $img_="../media/cafe/".($cafe[$a]['cafe_code'])."/search_".($cafe[$a]['cafe_code']).".jpg"  ;
				     	echo ("<div style='min-height:246px;;background: white';position:relative>");
				   
				     
				     echo(" <div style='background: purple;width:27%;left: 0;bottom: 0;right:0;top:0'> <img style='width:100%' src='".$img_. "'  />    </div>");
				     	
				     } 

                     if ($odd =='even'){
                     	    $img_=$cafe[$a]['ftrpath']."/".($cafe[$a]['ftrcode'].$cafe[$a]['ftrext']);
							echo(" <div style='background: orange;width:63%;position:absolute;left: 37%;bottom: 0;right:0;top:0'> <img  style='width:100%' src='".$img_. "'  />  </div>");
